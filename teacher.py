...
Updated to work with any AI provider (OpenAI, Gemini, Groq, Anthropic, etc.)
"""
...
- [List 3-5 specific areas needing improvement with suggestions]

CORRECTIONS:
[For any incorrect information, provide the correct information]

FEEDBACK:
[Provide encouraging, constructive, and detailed feedback]

RECOMMENDATIONS:
[Specific study recommendations and resources]
"""
    ...
    def _generate_fallback_grade(self, answer: str, model_answer: str, rubric: Dict, student_info: Dict) -> Dict[str, Any]:
        """Generate a basic grade when AI grading fails"""
        ...
        return {
            ...
            'feedback': f"Automated grading based on similarity analysis. Score: {score}/{rubric.get('total_points', 100)}",
            'strengths': ['Answer provided', 'Attempt made'],
            'improvements': ['More detail needed', 'Review model answer'],
            'corrections': '',
            'recommendations': 'Review course materials and model answer',
